function initialize() {
	...
	var mapProp = {
	  //fonte latitude longitude: www.latlong.net
	  center:new google.maps.LatLng(-9.923870,-63.041510),
	  zoom:14,
		 scrollwheel: false,
	   styles: [{
	  stylers: [{
...
$(function(){
    ...
    initialize();
    //parâmetro indefinido: ao clicar sobre localização mostra descrição
    //pode usar false ou true também nos parâmetros
